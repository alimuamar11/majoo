  ...
  <body class="az-body">
    <div class="az-signin-wrapper" style="background: #ccc">
      ...
      <div class="az-signin-header">
          ...
          <?=conf('company_name');?></h2>
          <h4 class="text-disabled">Silakan lengkapi data anda untuk registrasi sebagai calon pasien</h4>
        ...
        <div class="az-signin-footer">
          <p>&nbsp;</p>
          <p>
						Ada akun? click <a class="btn btn-xs btn-az-primary text-white" href="<?=base_url('auth');?>">Masuk</a>
...
<script>
  ...
  .on('keypress',"input",function(e){
	...
	.on("click","#submit_register",function(e){
		...
		http_request('admin/auth/self-register','POST',form)
		.done(function(res){
